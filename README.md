...
![](https://github.com/mauta/covid-dashboard/blob/master/covid.png)
...
Задание выполнялось в команде из двух человек. Для работы с интерактивной картой использовался Mapbox GL JS, график выполнен на канвас без использования сторонних библиотек.    
